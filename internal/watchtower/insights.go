...
func (s *Service) GetPullRequestInsightsByOrg(orgID int64, filterDate insights.FilterDateDays) (insights.PullRequestInsights, error) {
...
func (s *Service) GetSecurityInsightsByOrg(orgID int64, filterDate insights.FilterDateDays) (insights.SecurityInsights, error) {
